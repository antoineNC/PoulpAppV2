...
export default function ParteAdd({ navigation, route }: ParteAddProps) {
  ...
  const [partenariat, setPartenariat] = useState<Partenariat>({
    id: "",
    nom: "",
    description: "",
    adresse: "",
  ...
  const addParte = () => {
    // Vérification si le partenariat n'est pas vide (il doit contenir au moins un titre)
    if (partenariat.nom != "") {
      var nvPartenariat = partenariat;
      nvPartenariat.bureau = idBureau;
      setPartenariat(nvPartenariat);
      firestoreService.addPartenariat(nvPartenariat);
      navigation.goBack();
    } else {
      Alert.alert("Erreur", "Le partenariat doit au moins contenir un nom.");
    }
  };
      ...
      <View style={styles.mainContainer}>
        ...
        {partenariat.image != "" ? (
          <View style={styles.imageView}>
            <Image source={{ uri: partenariat.image }} style={styles.image} />
        ...
        <TouchableOpacity
          ...
          onPress={addParte}
        >
          <Text style={styles.appButtonText}>Ajouter le partenariat</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
